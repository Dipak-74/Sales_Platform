...
function AdminOrders() {
  ...
  return (
    <MainLayout title="Orders" breadcrumb={["Dashboard", "Orders"]} userName={userName || "Admin"}>
      <div className="panel-card" style={{ display: "grid", gap: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 }}>
          <div>
            <h3 style={{ margin: 0 }}>Customer Orders</h3>
            <small style={{ color: "var(--text-muted)" }}>Monitor order lifecycle, fulfillment and status updates</small>
          </div>
