...
function ManagerOrders() {
  ...
  const handleUpdateStatus = async (id, newStatus) => {
    try {
      ...
      setSuccessMsg(`Order #${id} status updated to ${newStatus}.`);
  ...
  return (
    <MainLayout title="Orders" breadcrumb={["Dashboard", "Orders"]} userName={userName || "Manager"}>
      <div className="panel-card" style={{ display: "grid", gap: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 }}>
          <div>
            <h3 style={{ margin: 0 }}>Order Fulfillment</h3>
            <small style={{ color: "var(--text-muted)" }}>Process and track order progress</small>
          </div>
