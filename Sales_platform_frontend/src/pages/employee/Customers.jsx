...
function EmployeeCustomers() {
  ...
  return (
    <MainLayout title="Customers" breadcrumb={["Dashboard", "Customers"]} userName={userName || "Employee"}>
      <div className="panel-card" style={{ display: "grid", gap: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 }}>
          <div>
            <h3 style={{ margin: 0 }}>Customer Inquiry & Delivery Contacts</h3>
            <small style={{ color: "var(--text-muted)" }}>Lookup customer contact details and delivery addresses</small>
          </div>
